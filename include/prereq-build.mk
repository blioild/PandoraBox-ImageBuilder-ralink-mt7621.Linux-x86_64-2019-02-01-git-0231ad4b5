...
$(eval $(call TestHostCommand,help2man, \
	Please install GNU help2man , \
	help2man --version |grep GNU))

$(eval $(call TestHostCommand,texinfo, \
	Please install GNU texinfo , \
	makeinfo  --version |grep GNU))
	
$(eval $(call TestHostCommand,cmake, \
	Please install cmake , \
	cmake  --version |grep version))
	
#$(eval $(call TestHostCommand,yui-compressor, \
#	Please install yui-compressor , \
#	yui-compressor -V))

$(eval $(call TestHostCommand,go, \
	Please install golang , \
	go env |grep GOROOT))

$(eval $(call TestHostCommand,npm, \
